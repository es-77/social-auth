<div class="emmanuel-saleem-social-auth">
    ...
    <div class="es-social-buttons">
        {{-- Google Button --}}
        <a href="{{ route('emmanuel-saleem.social-auth.google') }}" class="es-social-btn es-google-btn">
        ...
        {{-- Microsoft Button --}}
        <a href="{{ route('emmanuel-saleem.social-auth.microsoft') }}" class="es-social-btn es-microsoft-btn">
            <svg class="es-icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
